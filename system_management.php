...
<body>
	...
	<div class="content">
		...
		echo "<h1>Welcome $use to TEAU 2022 elections management page. <br> You are an admin</h1>";
					...
					if (mysqli_stmt_execute($stmt))
					{
						...
						else
						{
								...
								else
								{
									...
									alert("Candidate registration not successful")
									</script>';
								}
	...
	echo $_SESSION["secs"];*/
		...
		?><div class="display_time">
			...
			<h1>Elections starts on <?php echo $start_date;?></h1>
		...
		<div>
			<form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="candidate_reg" enctype="multipart/form-data">
				<label style="color: blue; font-size: 33px;">Candidate registration</label>
				<div id="form_cont">
				...
				<select name="cand_pos" id="gen">
					...
					<option value="internal affairs">internal affairs minister</option>
	...
	<form id="set_date" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" id="candidate_reg" enctype="multipart/form-data" method="post">
		<div id="labi">
	<label >Set election date and time</label>
	</div>	
	<div id="form_cont">
	<label>Starting date</label><br>
	<input type="datetime-local" name="sdate"><br>
</div>

	<div id="form_cont">	
	<label>Ending date</label><br>
	<input type="datetime-local" name="edate"><br>
</div>

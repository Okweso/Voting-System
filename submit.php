...
$candidate_vote=array("pres_id", "dpres", "fmin", "emin", "tmin", "smin", "sec", "imin");
...
$qrry=$conn->query("UPDATE student SET status=1 WHERE admission_number='$name'") or die(mysqli_errno());
#echo $name;
